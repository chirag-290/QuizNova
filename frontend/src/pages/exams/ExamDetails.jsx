...
import { Clock, Users, Award, Edit, Trash2, AlertTriangle, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {/* Admin/Examiner Actions */}
        {(user.role === 'Admin' || (user.role === 'Examiner' && exam.createdBy?._id === user._id)) && (
        ...
        <div className="p-6">
          <div className="flex flex-wrap gap-6 mb-6">
            <div className="flex items-center">
              ...
              <span className="text-gray-700">Duration: <strong>{exam.duration} minutes</strong></span>
            </div>
            <div className="flex items-center">
              <Award className="h-5 w-5 text-indigo-600 mr-2" />
              <span className="text-gray-700">Passing Score: <strong>{exam.passingScore}%</strong></span>
            </div>
            <div className="flex items-center">
              <Users className="h-5 w-5 text-indigo-600 mr-2" />
              <span className="text-gray-700">Total Questions: <strong>{exam.questions?.length || 0}</strong></span>
            </div>
          </div>
      ...
      {/* Question Preview (Admin/Examiner only) */}
                ...
                {question.type === 'MCQ' && question.options && (
                  <div className="mt-3 space-y-2">
                    {question.options.map((option, optIndex) => (
                      ...
                      >
                        <span className={option === question.correctAnswer ? 'text-green-700' : 'text-gray-700'}>
                          {option}
                          {option === question.correctAnswer && ' ✓'}
                        </span>
                      </div>
