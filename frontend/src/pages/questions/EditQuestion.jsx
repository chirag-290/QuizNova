    ...
    <div className="font-sans bg-gradient-to-br from-[#0d1117] to-[#1f2937] text-white min-h-screen pb-12 animate-fade-in">
      ...
      <section className="relative py-12 px-6 overflow-hidden bg-[#1f1f1f] rounded-b-[3rem] shadow-xl mb-12">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">Edit Question</h1>
          <p className="text-lg text-gray-300 max-w-3xl">
            Update your question details and answer options.
          </p>
        </div>
      </section>
      ...
      <div className="px-6 max-w-6xl mx-auto">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-center md:justify-end">
            ...
            >
              {submitting ? <Spinner size="small" /> : 'Update Question'}
            </button>
          </div>
        </form>
      </div>
