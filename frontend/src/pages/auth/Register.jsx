  ...
  return (
    <div className="font-sans bg-gradient-to-br from-[#0d1117] to-[#1f2937] min-h-screen flex flex-col justify-center items-center px-6 py-12">
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="w-full relative z-10 bg-[#1f2937] backdrop-blur-md shadow-2xl rounded-3xl overflow-hidden border border-gray-700/50 animate-fade-in">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-8">
            <div>
              ...
              />
              {errors.name && (
                <p className="mt-2 text-sm text-red-400 animate-fade-up">
                  {errors.name.message}
                </p>
              )}
            </div>
